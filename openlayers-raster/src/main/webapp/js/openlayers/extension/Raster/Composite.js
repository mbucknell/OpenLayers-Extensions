...
OpenLayers.Raster.Composite.fromLayer = function(layer, options) {
    ...
    if (layer instanceof OpenLayers.Layer.Grid) {
        composite = OpenLayers.Raster.Composite.fromGridLayer(layer, options);
...
OpenLayers.Raster.Composite.fromGridLayer = function(layer, options) {
    
    var canvas = document.createElement("canvas");
    var context = canvas.getContext("2d");
    var int32 = options && options.int32 && options.int32 === true;
